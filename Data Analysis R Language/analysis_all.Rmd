...
ggsave(filename = "./figure/production expectation.png", production_expectation, width = 15, height = 8, units = "cm")
...
ggsave(filename = "./figure/interpretation.png", interpretation, width = 15, height = 8, units = "cm")
```
...
ggsave(filename = "./figure/correlation.png", correlation, width = 10, height = 10, units = "cm")
